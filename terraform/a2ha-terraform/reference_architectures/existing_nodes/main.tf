...
module "system-tuning-chef_server" {
  ...
  automate_archive_disk_fs_path      = var.automate_archive_disk_fs_path
  elasticsearch_archive_disk_fs_path = var.elasticsearch_archive_disk_fs_path
  instance_count                     = length(setsubtract(var.existing_chef_server_private_ips, var.existing_automate_private_ips))
  postgresql_archive_disk_fs_path    = var.postgresql_archive_disk_fs_path
  private_ips                        = setsubtract(var.existing_chef_server_private_ips, var.existing_automate_private_ips)
  ssh_key_file                       = var.ssh_key_file
  ssh_user                           = var.ssh_user
  ssh_user_sudo_password             = local.fe_sudo_password
  sudo_cmd                           = var.sudo_cmd
...
module "system-tuning-postgresql" {
  ...
  automate_archive_disk_fs_path      = var.automate_archive_disk_fs_path
  elasticsearch_archive_disk_fs_path = var.elasticsearch_archive_disk_fs_path
  instance_count                     = length(setsubtract(var.existing_elasticsearch_private_ips, var.existing_postgresql_private_ips))
  postgresql_archive_disk_fs_path    = var.postgresql_archive_disk_fs_path
  private_ips                        = setsubtract(var.existing_elasticsearch_private_ips, var.existing_postgresql_private_ips)
  ssh_key_file                       = var.ssh_key_file
  ssh_user                           = var.ssh_user
  ssh_user_sudo_password             = local.be_sudo_password
  sudo_cmd                           = var.sudo_cmd
...
module "habitat-chef_server" {
  ...
  backend_aib_local_file          = var.backend_aib_local_file
  private_ips                     = setsubtract(var.existing_chef_server_private_ips, var.existing_automate_private_ips)
  peer_ips                        = setsubtract(var.existing_chef_server_private_ips, var.existing_automate_private_ips)
  ssh_key_file                    = var.ssh_key_file
  ssh_user                        = var.ssh_user
  ssh_user_sudo_password          = local.fe_sudo_password
  sudo_cmd                        = var.sudo_cmd
