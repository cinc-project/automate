...
func NewCompliancePipeline(client *ingestic.ESClient, authzClient authz.ProjectsServiceClient,
	nodeMgrClient manager.NodeManagerServiceClient, messageBufferSize int, notifierClient notifier.Notifier, automateURL string, isUpdated bool) Compliance {
	...
	compliancePipeline(in,
		...
		processor.ComplianceReport(notifierClient, automateURL, isUpdated),
