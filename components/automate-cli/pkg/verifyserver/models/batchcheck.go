...
func (c *Config) populateAwsManagedServicesConfig(haConfig *config.HaDeployConfig) {
	...
	c.ExternalOS = &ExternalOS{
		OSDomainName:   awsManagedServicesConfig.ManagedOpensearchDomainName,
		OSDomainURL:    awsManagedServicesConfig.ManagedOpensearchDomainURL,
		OSCert:         awsManagedServicesConfig.ManagedOpensearchCertificate,
		OSUserPassword: awsManagedServicesConfig.ManagedOpensearchUserPassword,
		OSUsername:     awsManagedServicesConfig.ManagedOpensearchUsername,
		OSRoleArn:      awsManagedServicesConfig.AwsOsSnapshotRoleArn,
	}
}
