...
//
// * when there are no rules, no alerts are sent (for each event type)
...
// (see: https://github.com/chef/automate/blob/5b457d40fb8ec494d69678bc595c264ca4b9bf94/components/notifications-service/server/lib/prefilter.ex )
// NOTE: there's a critical controls only setting on the service now alert type
// but this cannot possibly do anything
//
// Related:
// * test the webhook validator for success/error cases
//
// ISTR there is some kind of roll-up or rate-limiter?
