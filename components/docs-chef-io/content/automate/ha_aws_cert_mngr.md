...
[menu]
  [menu.automate]
    title = "AWS Certificate Manager"
    parent = "automate/install_high_availability/certificates"
    identifier = "automate/install_high_availability/certificates/ha_aws_cert_mngr.md AWS Certificate Manager"
    weight = 200
+++
