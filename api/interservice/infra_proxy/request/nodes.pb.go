...
var file_interservice_infra_proxy_request_nodes_proto_rawDesc = []byte{
	...
	0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0x54, 0x0a,
...
var file_interservice_infra_proxy_request_nodes_proto_depIdxs = []int32{
	4, // 0: chef.automate.domain.infra_proxy.request.Nodes.search_query:type_name -> chef.automate.domain.infra_proxy.request.SearchQuery
	5, // 1: chef.automate.domain.infra_proxy.request.UpdateNode.automatic_attributes:type_name -> google.protobuf.Struct
	5, // 2: chef.automate.domain.infra_proxy.request.UpdateNode.default_attributes:type_name -> google.protobuf.Struct
	5, // 3: chef.automate.domain.infra_proxy.request.UpdateNode.normal_attributes:type_name -> google.protobuf.Struct
	5, // 4: chef.automate.domain.infra_proxy.request.UpdateNode.override_attributes:type_name -> google.protobuf.Struct
