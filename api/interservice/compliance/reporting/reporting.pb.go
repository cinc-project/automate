...
var file_interservice_compliance_reporting_reporting_proto_depIdxs = []int32{
	...
	60, // 96: chef.automate.domain.compliance.reporting.ReportingService.ListAsset:output_type -> chef.automate.domain.compliance.reporting.AssetListResponse
	62, // 97: chef.automate.domain.compliance.reporting.ReportingService.SetAssetConfig:output_type -> chef.automate.domain.compliance.reporting.ComplianceConfigResponse
	62, // 98: chef.automate.domain.compliance.reporting.ReportingService.GetAssetConfig:output_type -> chef.automate.domain.compliance.reporting.ComplianceConfigResponse
