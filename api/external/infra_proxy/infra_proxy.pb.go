...
var file_external_infra_proxy_infra_proxy_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0x97, 0x60, 0x0a,
...
var file_external_infra_proxy_infra_proxy_proto_goTypes = []interface{}{
	...
	(*request.DeleteNode)(nil),              // 35: chef.automate.api.infra_proxy.request.DeleteNode
	(*request.UpdateNode)(nil),              // 36: chef.automate.api.infra_proxy.request.UpdateNode
	(*request.Node)(nil),                    // 37: chef.automate.api.infra_proxy.request.Node
	(*request.Policyfiles)(nil),             // 38: chef.automate.api.infra_proxy.request.Policyfiles
	(*request.Policyfile)(nil),              // 39: chef.automate.api.infra_proxy.request.Policyfile
	(*response.GetServers)(nil),             // 40: chef.automate.api.infra_proxy.response.GetServers
	(*response.GetServer)(nil),              // 41: chef.automate.api.infra_proxy.response.GetServer
	(*response.CreateServer)(nil),           // 42: chef.automate.api.infra_proxy.response.CreateServer
	(*response.UpdateServer)(nil),           // 43: chef.automate.api.infra_proxy.response.UpdateServer
	(*response.DeleteServer)(nil),           // 44: chef.automate.api.infra_proxy.response.DeleteServer
	(*response.GetOrgs)(nil),                // 45: chef.automate.api.infra_proxy.response.GetOrgs
	(*response.GetOrg)(nil),                 // 46: chef.automate.api.infra_proxy.response.GetOrg
	(*response.CreateOrg)(nil),              // 47: chef.automate.api.infra_proxy.response.CreateOrg
	(*response.UpdateOrg)(nil),              // 48: chef.automate.api.infra_proxy.response.UpdateOrg
	(*response.DeleteOrg)(nil),              // 49: chef.automate.api.infra_proxy.response.DeleteOrg
	(*response.ResetOrgAdminKey)(nil),       // 50: chef.automate.api.infra_proxy.response.ResetOrgAdminKey
	(*response.Cookbooks)(nil),              // 51: chef.automate.api.infra_proxy.response.Cookbooks
	(*response.CookbookVersions)(nil),       // 52: chef.automate.api.infra_proxy.response.CookbookVersions
	(*response.Cookbook)(nil),               // 53: chef.automate.api.infra_proxy.response.Cookbook
	(*response.CookbookFileContent)(nil),    // 54: chef.automate.api.infra_proxy.response.CookbookFileContent
	(*response.Roles)(nil),                  // 55: chef.automate.api.infra_proxy.response.Roles
	(*response.Role)(nil),                   // 56: chef.automate.api.infra_proxy.response.Role
	(*response.Clients)(nil),                // 57: chef.automate.api.infra_proxy.response.Clients
	(*response.Client)(nil),                 // 58: chef.automate.api.infra_proxy.response.Client
	(*response.CreateClient)(nil),           // 59: chef.automate.api.infra_proxy.response.CreateClient
	(*response.ClientKey)(nil),              // 60: chef.automate.api.infra_proxy.response.ClientKey
	(*response.DataBags)(nil),               // 61: chef.automate.api.infra_proxy.response.DataBags
	(*response.DataBagItems)(nil),           // 62: chef.automate.api.infra_proxy.response.DataBagItems
	(*response.DataBagItem)(nil),            // 63: chef.automate.api.infra_proxy.response.DataBagItem
	(*response.CreateDataBag)(nil),          // 64: chef.automate.api.infra_proxy.response.CreateDataBag
	(*response.CreateDataBagItem)(nil),      // 65: chef.automate.api.infra_proxy.response.CreateDataBagItem
	(*response.DataBag)(nil),                // 66: chef.automate.api.infra_proxy.response.DataBag
	(*response.UpdateDataBagItem)(nil),      // 67: chef.automate.api.infra_proxy.response.UpdateDataBagItem
	(*response.Environments)(nil),           // 68: chef.automate.api.infra_proxy.response.Environments
	(*response.Environment)(nil),            // 69: chef.automate.api.infra_proxy.response.Environment
	(*response.EnvironmentRecipesList)(nil), // 70: chef.automate.api.infra_proxy.response.EnvironmentRecipesList
	(*response.Nodes)(nil),                  // 71: chef.automate.api.infra_proxy.response.Nodes
	(*response.DeleteNode)(nil),             // 72: chef.automate.api.infra_proxy.response.DeleteNode
	(*response.UpdateNode)(nil),             // 73: chef.automate.api.infra_proxy.response.UpdateNode
	(*response.Node)(nil),                   // 74: chef.automate.api.infra_proxy.response.Node
	(*response.Policyfiles)(nil),            // 75: chef.automate.api.infra_proxy.response.Policyfiles
	(*response.Policyfile)(nil),             // 76: chef.automate.api.infra_proxy.response.Policyfile
}
var file_external_infra_proxy_infra_proxy_proto_depIdxs = []int32{
	...
	35, // 40: chef.automate.api.infra_proxy.InfraProxy.DeleteNode:input_type -> chef.automate.api.infra_proxy.request.DeleteNode
	36, // 41: chef.automate.api.infra_proxy.InfraProxy.UpdateNode:input_type -> chef.automate.api.infra_proxy.request.UpdateNode
	37, // 42: chef.automate.api.infra_proxy.InfraProxy.GetNode:input_type -> chef.automate.api.infra_proxy.request.Node
	38, // 43: chef.automate.api.infra_proxy.InfraProxy.GetPolicyfiles:input_type -> chef.automate.api.infra_proxy.request.Policyfiles
	39, // 44: chef.automate.api.infra_proxy.InfraProxy.GetPolicyfile:input_type -> chef.automate.api.infra_proxy.request.Policyfile
	40, // 45: chef.automate.api.infra_proxy.InfraProxy.GetServers:output_type -> chef.automate.api.infra_proxy.response.GetServers
	41, // 46: chef.automate.api.infra_proxy.InfraProxy.GetServer:output_type -> chef.automate.api.infra_proxy.response.GetServer
	42, // 47: chef.automate.api.infra_proxy.InfraProxy.CreateServer:output_type -> chef.automate.api.infra_proxy.response.CreateServer
	43, // 48: chef.automate.api.infra_proxy.InfraProxy.UpdateServer:output_type -> chef.automate.api.infra_proxy.response.UpdateServer
	44, // 49: chef.automate.api.infra_proxy.InfraProxy.DeleteServer:output_type -> chef.automate.api.infra_proxy.response.DeleteServer
	45, // 50: chef.automate.api.infra_proxy.InfraProxy.GetOrgs:output_type -> chef.automate.api.infra_proxy.response.GetOrgs
	46, // 51: chef.automate.api.infra_proxy.InfraProxy.GetOrg:output_type -> chef.automate.api.infra_proxy.response.GetOrg
	47, // 52: chef.automate.api.infra_proxy.InfraProxy.CreateOrg:output_type -> chef.automate.api.infra_proxy.response.CreateOrg
	48, // 53: chef.automate.api.infra_proxy.InfraProxy.UpdateOrg:output_type -> chef.automate.api.infra_proxy.response.UpdateOrg
	49, // 54: chef.automate.api.infra_proxy.InfraProxy.DeleteOrg:output_type -> chef.automate.api.infra_proxy.response.DeleteOrg
	50, // 55: chef.automate.api.infra_proxy.InfraProxy.ResetOrgAdminKey:output_type -> chef.automate.api.infra_proxy.response.ResetOrgAdminKey
	51, // 56: chef.automate.api.infra_proxy.InfraProxy.GetCookbooks:output_type -> chef.automate.api.infra_proxy.response.Cookbooks
	52, // 57: chef.automate.api.infra_proxy.InfraProxy.GetCookbookVersions:output_type -> chef.automate.api.infra_proxy.response.CookbookVersions
	53, // 58: chef.automate.api.infra_proxy.InfraProxy.GetCookbook:output_type -> chef.automate.api.infra_proxy.response.Cookbook
	54, // 59: chef.automate.api.infra_proxy.InfraProxy.GetCookbookFileContent:output_type -> chef.automate.api.infra_proxy.response.CookbookFileContent
	55, // 60: chef.automate.api.infra_proxy.InfraProxy.GetRoles:output_type -> chef.automate.api.infra_proxy.response.Roles
	56, // 61: chef.automate.api.infra_proxy.InfraProxy.GetRole:output_type -> chef.automate.api.infra_proxy.response.Role
	56, // 62: chef.automate.api.infra_proxy.InfraProxy.CreateRole:output_type -> chef.automate.api.infra_proxy.response.Role
	56, // 63: chef.automate.api.infra_proxy.InfraProxy.DeleteRole:output_type -> chef.automate.api.infra_proxy.response.Role
	56, // 64: chef.automate.api.infra_proxy.InfraProxy.UpdateRole:output_type -> chef.automate.api.infra_proxy.response.Role
	57, // 65: chef.automate.api.infra_proxy.InfraProxy.GetClients:output_type -> chef.automate.api.infra_proxy.response.Clients
	58, // 66: chef.automate.api.infra_proxy.InfraProxy.GetClient:output_type -> chef.automate.api.infra_proxy.response.Client
	59, // 67: chef.automate.api.infra_proxy.InfraProxy.CreateClient:output_type -> chef.automate.api.infra_proxy.response.CreateClient
	58, // 68: chef.automate.api.infra_proxy.InfraProxy.DeleteClient:output_type -> chef.automate.api.infra_proxy.response.Client
	60, // 69: chef.automate.api.infra_proxy.InfraProxy.ResetClientKey:output_type -> chef.automate.api.infra_proxy.response.ClientKey
	61, // 70: chef.automate.api.infra_proxy.InfraProxy.GetDataBags:output_type -> chef.automate.api.infra_proxy.response.DataBags
	62, // 71: chef.automate.api.infra_proxy.InfraProxy.GetDataBagItems:output_type -> chef.automate.api.infra_proxy.response.DataBagItems
	63, // 72: chef.automate.api.infra_proxy.InfraProxy.GetDataBagItem:output_type -> chef.automate.api.infra_proxy.response.DataBagItem
	64, // 73: chef.automate.api.infra_proxy.InfraProxy.CreateDataBag:output_type -> chef.automate.api.infra_proxy.response.CreateDataBag
	65, // 74: chef.automate.api.infra_proxy.InfraProxy.CreateDataBagItem:output_type -> chef.automate.api.infra_proxy.response.CreateDataBagItem
	66, // 75: chef.automate.api.infra_proxy.InfraProxy.DeleteDataBag:output_type -> chef.automate.api.infra_proxy.response.DataBag
	63, // 76: chef.automate.api.infra_proxy.InfraProxy.DeleteDataBagItem:output_type -> chef.automate.api.infra_proxy.response.DataBagItem
	67, // 77: chef.automate.api.infra_proxy.InfraProxy.UpdateDataBagItem:output_type -> chef.automate.api.infra_proxy.response.UpdateDataBagItem
	68, // 78: chef.automate.api.infra_proxy.InfraProxy.GetEnvironments:output_type -> chef.automate.api.infra_proxy.response.Environments
	69, // 79: chef.automate.api.infra_proxy.InfraProxy.GetEnvironment:output_type -> chef.automate.api.infra_proxy.response.Environment
	69, // 80: chef.automate.api.infra_proxy.InfraProxy.CreateEnvironment:output_type -> chef.automate.api.infra_proxy.response.Environment
	69, // 81: chef.automate.api.infra_proxy.InfraProxy.DeleteEnvironment:output_type -> chef.automate.api.infra_proxy.response.Environment
	69, // 82: chef.automate.api.infra_proxy.InfraProxy.UpdateEnvironment:output_type -> chef.automate.api.infra_proxy.response.Environment
	70, // 83: chef.automate.api.infra_proxy.InfraProxy.GetEnvironmentRecipes:output_type -> chef.automate.api.infra_proxy.response.EnvironmentRecipesList
	71, // 84: chef.automate.api.infra_proxy.InfraProxy.GetNodes:output_type -> chef.automate.api.infra_proxy.response.Nodes
	72, // 85: chef.automate.api.infra_proxy.InfraProxy.DeleteNode:output_type -> chef.automate.api.infra_proxy.response.DeleteNode
	73, // 86: chef.automate.api.infra_proxy.InfraProxy.UpdateNode:output_type -> chef.automate.api.infra_proxy.response.UpdateNode
	74, // 87: chef.automate.api.infra_proxy.InfraProxy.GetNode:output_type -> chef.automate.api.infra_proxy.response.Node
	75, // 88: chef.automate.api.infra_proxy.InfraProxy.GetPolicyfiles:output_type -> chef.automate.api.infra_proxy.response.Policyfiles
	76, // 89: chef.automate.api.infra_proxy.InfraProxy.GetPolicyfile:output_type -> chef.automate.api.infra_proxy.response.Policyfile
