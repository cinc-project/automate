...
var file_external_infra_proxy_infra_proxy_proto_rawDesc = []byte{
	...
	0x6f, 0x32, 0xe6, 0x79, 0x0a, 0x0a, 0x49, 0x6e, 0x66, 0x72, 0x61, 0x50, 0x72, 0x6f, 0x78, 0x79,
	...
	0x72, 0x76, 0x65, 0x72, 0x73, 0x3a, 0x6c, 0x69, 0x73, 0x74, 0x12, 0xc8, 0x01, 0x0a, 0x0f, 0x47,
	...
	0x44, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x0a, 0x12, 0x08, 0x2f, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75,
	0x73, 0x8a, 0xb5, 0x18, 0x14, 0x0a, 0x12, 0x69, 0x6e, 0x66, 0x72, 0x61, 0x3a, 0x69, 0x6e, 0x66,
	0x72, 0x61, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x73, 0x8a, 0xb5, 0x18, 0x18, 0x12, 0x16, 0x69,
	0x6e, 0x66, 0x72, 0x61, 0x3a, 0x69, 0x6e, 0x66, 0x72, 0x61, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72,
	0x73, 0x3a, 0x67, 0x65, 0x74, 0x12, 0xcd, 0x01, 0x0a, 0x09, 0x47, 0x65, 0x74, 0x53, 0x65, 0x72,
...
var file_external_infra_proxy_infra_proxy_proto_goTypes = []interface{}{
	...
	(*response.GetServerStatus)(nil),        // 50: chef.automate.api.infra_proxy.response.GetServerStatus
	(*response.GetServer)(nil),              // 51: chef.automate.api.infra_proxy.response.GetServer
	(*response.CreateServer)(nil),           // 52: chef.automate.api.infra_proxy.response.CreateServer
	(*response.UpdateServer)(nil),           // 53: chef.automate.api.infra_proxy.response.UpdateServer
	(*response.DeleteServer)(nil),           // 54: chef.automate.api.infra_proxy.response.DeleteServer
	(*response.GetOrgs)(nil),                // 55: chef.automate.api.infra_proxy.response.GetOrgs
	(*response.GetOrg)(nil),                 // 56: chef.automate.api.infra_proxy.response.GetOrg
	(*response.CreateOrg)(nil),              // 57: chef.automate.api.infra_proxy.response.CreateOrg
	(*response.UpdateOrg)(nil),              // 58: chef.automate.api.infra_proxy.response.UpdateOrg
	(*response.DeleteOrg)(nil),              // 59: chef.automate.api.infra_proxy.response.DeleteOrg
	(*response.ResetOrgAdminKey)(nil),       // 60: chef.automate.api.infra_proxy.response.ResetOrgAdminKey
	(*response.Cookbooks)(nil),              // 61: chef.automate.api.infra_proxy.response.Cookbooks
	(*response.CookbookVersions)(nil),       // 62: chef.automate.api.infra_proxy.response.CookbookVersions
	(*response.Cookbook)(nil),               // 63: chef.automate.api.infra_proxy.response.Cookbook
	(*response.CookbookFileContent)(nil),    // 64: chef.automate.api.infra_proxy.response.CookbookFileContent
	(*response.Roles)(nil),                  // 65: chef.automate.api.infra_proxy.response.Roles
	(*response.Role)(nil),                   // 66: chef.automate.api.infra_proxy.response.Role
	(*response.ExpandedRunList)(nil),        // 67: chef.automate.api.infra_proxy.response.ExpandedRunList
	(*response.RoleEnvironments)(nil),       // 68: chef.automate.api.infra_proxy.response.RoleEnvironments
	(*response.Clients)(nil),                // 69: chef.automate.api.infra_proxy.response.Clients
	(*response.Client)(nil),                 // 70: chef.automate.api.infra_proxy.response.Client
	(*response.CreateClient)(nil),           // 71: chef.automate.api.infra_proxy.response.CreateClient
	(*response.ResetClient)(nil),            // 72: chef.automate.api.infra_proxy.response.ResetClient
	(*response.DataBags)(nil),               // 73: chef.automate.api.infra_proxy.response.DataBags
	(*response.DataBagItems)(nil),           // 74: chef.automate.api.infra_proxy.response.DataBagItems
	(*response.DataBagItem)(nil),            // 75: chef.automate.api.infra_proxy.response.DataBagItem
	(*response.CreateDataBag)(nil),          // 76: chef.automate.api.infra_proxy.response.CreateDataBag
	(*response.CreateDataBagItem)(nil),      // 77: chef.automate.api.infra_proxy.response.CreateDataBagItem
	(*response.DataBag)(nil),                // 78: chef.automate.api.infra_proxy.response.DataBag
	(*response.UpdateDataBagItem)(nil),      // 79: chef.automate.api.infra_proxy.response.UpdateDataBagItem
	(*response.Environments)(nil),           // 80: chef.automate.api.infra_proxy.response.Environments
	(*response.Environment)(nil),            // 81: chef.automate.api.infra_proxy.response.Environment
	(*response.EnvironmentRecipesList)(nil), // 82: chef.automate.api.infra_proxy.response.EnvironmentRecipesList
	(*response.Nodes)(nil),                  // 83: chef.automate.api.infra_proxy.response.Nodes
	(*response.DeleteNode)(nil),             // 84: chef.automate.api.infra_proxy.response.DeleteNode
	(*response.Node)(nil),                   // 85: chef.automate.api.infra_proxy.response.Node
	(*response.UpdateNodeAttributes)(nil),   // 86: chef.automate.api.infra_proxy.response.UpdateNodeAttributes
	(*response.NodeExpandedRunList)(nil),    // 87: chef.automate.api.infra_proxy.response.NodeExpandedRunList
	(*response.UpdateNodeTags)(nil),         // 88: chef.automate.api.infra_proxy.response.UpdateNodeTags
	(*response.UpdateNodeEnvironment)(nil),  // 89: chef.automate.api.infra_proxy.response.UpdateNodeEnvironment
	(*response.Policyfiles)(nil),            // 90: chef.automate.api.infra_proxy.response.Policyfiles
	(*response.Policyfile)(nil),             // 91: chef.automate.api.infra_proxy.response.Policyfile
	(*response.DeletePolicyfile)(nil),       // 92: chef.automate.api.infra_proxy.response.DeletePolicyfile
	(*response.PolicyfileRevisions)(nil),    // 93: chef.automate.api.infra_proxy.response.PolicyfileRevisions
	(*response.Policygroup)(nil),            // 94: chef.automate.api.infra_proxy.response.Policygroup
	(*response.OrgUsers)(nil),               // 95: chef.automate.api.infra_proxy.response.OrgUsers
}
var file_external_infra_proxy_infra_proxy_proto_depIdxs = []int32{
	...
	50, // 57: chef.automate.api.infra_proxy.InfraProxy.GetServerStatus:output_type -> chef.automate.api.infra_proxy.response.GetServerStatus
	51, // 58: chef.automate.api.infra_proxy.InfraProxy.GetServer:output_type -> chef.automate.api.infra_proxy.response.GetServer
	52, // 59: chef.automate.api.infra_proxy.InfraProxy.CreateServer:output_type -> chef.automate.api.infra_proxy.response.CreateServer
	53, // 60: chef.automate.api.infra_proxy.InfraProxy.UpdateServer:output_type -> chef.automate.api.infra_proxy.response.UpdateServer
	54, // 61: chef.automate.api.infra_proxy.InfraProxy.DeleteServer:output_type -> chef.automate.api.infra_proxy.response.DeleteServer
	55, // 62: chef.automate.api.infra_proxy.InfraProxy.GetOrgs:output_type -> chef.automate.api.infra_proxy.response.GetOrgs
	56, // 63: chef.automate.api.infra_proxy.InfraProxy.GetOrg:output_type -> chef.automate.api.infra_proxy.response.GetOrg
	57, // 64: chef.automate.api.infra_proxy.InfraProxy.CreateOrg:output_type -> chef.automate.api.infra_proxy.response.CreateOrg
	58, // 65: chef.automate.api.infra_proxy.InfraProxy.UpdateOrg:output_type -> chef.automate.api.infra_proxy.response.UpdateOrg
	59, // 66: chef.automate.api.infra_proxy.InfraProxy.DeleteOrg:output_type -> chef.automate.api.infra_proxy.response.DeleteOrg
	60, // 67: chef.automate.api.infra_proxy.InfraProxy.ResetOrgAdminKey:output_type -> chef.automate.api.infra_proxy.response.ResetOrgAdminKey
	61, // 68: chef.automate.api.infra_proxy.InfraProxy.GetCookbooks:output_type -> chef.automate.api.infra_proxy.response.Cookbooks
	62, // 69: chef.automate.api.infra_proxy.InfraProxy.GetCookbookVersions:output_type -> chef.automate.api.infra_proxy.response.CookbookVersions
	63, // 70: chef.automate.api.infra_proxy.InfraProxy.GetCookbook:output_type -> chef.automate.api.infra_proxy.response.Cookbook
	64, // 71: chef.automate.api.infra_proxy.InfraProxy.GetCookbookFileContent:output_type -> chef.automate.api.infra_proxy.response.CookbookFileContent
	65, // 72: chef.automate.api.infra_proxy.InfraProxy.GetRoles:output_type -> chef.automate.api.infra_proxy.response.Roles
	66, // 73: chef.automate.api.infra_proxy.InfraProxy.GetRole:output_type -> chef.automate.api.infra_proxy.response.Role
	67, // 74: chef.automate.api.infra_proxy.InfraProxy.GetRoleExpandedRunList:output_type -> chef.automate.api.infra_proxy.response.ExpandedRunList
	68, // 75: chef.automate.api.infra_proxy.InfraProxy.GetRoleEnvironments:output_type -> chef.automate.api.infra_proxy.response.RoleEnvironments
	66, // 76: chef.automate.api.infra_proxy.InfraProxy.CreateRole:output_type -> chef.automate.api.infra_proxy.response.Role
	66, // 77: chef.automate.api.infra_proxy.InfraProxy.DeleteRole:output_type -> chef.automate.api.infra_proxy.response.Role
	66, // 78: chef.automate.api.infra_proxy.InfraProxy.UpdateRole:output_type -> chef.automate.api.infra_proxy.response.Role
	69, // 79: chef.automate.api.infra_proxy.InfraProxy.GetClients:output_type -> chef.automate.api.infra_proxy.response.Clients
	70, // 80: chef.automate.api.infra_proxy.InfraProxy.GetClient:output_type -> chef.automate.api.infra_proxy.response.Client
	71, // 81: chef.automate.api.infra_proxy.InfraProxy.CreateClient:output_type -> chef.automate.api.infra_proxy.response.CreateClient
	70, // 82: chef.automate.api.infra_proxy.InfraProxy.DeleteClient:output_type -> chef.automate.api.infra_proxy.response.Client
	72, // 83: chef.automate.api.infra_proxy.InfraProxy.ResetClientKey:output_type -> chef.automate.api.infra_proxy.response.ResetClient
	73, // 84: chef.automate.api.infra_proxy.InfraProxy.GetDataBags:output_type -> chef.automate.api.infra_proxy.response.DataBags
	74, // 85: chef.automate.api.infra_proxy.InfraProxy.GetDataBagItems:output_type -> chef.automate.api.infra_proxy.response.DataBagItems
	75, // 86: chef.automate.api.infra_proxy.InfraProxy.GetDataBagItem:output_type -> chef.automate.api.infra_proxy.response.DataBagItem
	76, // 87: chef.automate.api.infra_proxy.InfraProxy.CreateDataBag:output_type -> chef.automate.api.infra_proxy.response.CreateDataBag
	77, // 88: chef.automate.api.infra_proxy.InfraProxy.CreateDataBagItem:output_type -> chef.automate.api.infra_proxy.response.CreateDataBagItem
	78, // 89: chef.automate.api.infra_proxy.InfraProxy.DeleteDataBag:output_type -> chef.automate.api.infra_proxy.response.DataBag
	75, // 90: chef.automate.api.infra_proxy.InfraProxy.DeleteDataBagItem:output_type -> chef.automate.api.infra_proxy.response.DataBagItem
	79, // 91: chef.automate.api.infra_proxy.InfraProxy.UpdateDataBagItem:output_type -> chef.automate.api.infra_proxy.response.UpdateDataBagItem
	80, // 92: chef.automate.api.infra_proxy.InfraProxy.GetEnvironments:output_type -> chef.automate.api.infra_proxy.response.Environments
	81, // 93: chef.automate.api.infra_proxy.InfraProxy.GetEnvironment:output_type -> chef.automate.api.infra_proxy.response.Environment
	81, // 94: chef.automate.api.infra_proxy.InfraProxy.CreateEnvironment:output_type -> chef.automate.api.infra_proxy.response.Environment
	81, // 95: chef.automate.api.infra_proxy.InfraProxy.DeleteEnvironment:output_type -> chef.automate.api.infra_proxy.response.Environment
	81, // 96: chef.automate.api.infra_proxy.InfraProxy.UpdateEnvironment:output_type -> chef.automate.api.infra_proxy.response.Environment
	82, // 97: chef.automate.api.infra_proxy.InfraProxy.GetEnvironmentRecipes:output_type -> chef.automate.api.infra_proxy.response.EnvironmentRecipesList
	83, // 98: chef.automate.api.infra_proxy.InfraProxy.GetNodes:output_type -> chef.automate.api.infra_proxy.response.Nodes
	84, // 99: chef.automate.api.infra_proxy.InfraProxy.DeleteNode:output_type -> chef.automate.api.infra_proxy.response.DeleteNode
	85, // 100: chef.automate.api.infra_proxy.InfraProxy.UpdateNode:output_type -> chef.automate.api.infra_proxy.response.Node
	86, // 101: chef.automate.api.infra_proxy.InfraProxy.UpdateNodeAttributes:output_type -> chef.automate.api.infra_proxy.response.UpdateNodeAttributes
	85, // 102: chef.automate.api.infra_proxy.InfraProxy.GetNode:output_type -> chef.automate.api.infra_proxy.response.Node
	87, // 103: chef.automate.api.infra_proxy.InfraProxy.GetNodeExpandedRunList:output_type -> chef.automate.api.infra_proxy.response.NodeExpandedRunList
	88, // 104: chef.automate.api.infra_proxy.InfraProxy.UpdateNodeTags:output_type -> chef.automate.api.infra_proxy.response.UpdateNodeTags
	89, // 105: chef.automate.api.infra_proxy.InfraProxy.UpdateNodeEnvironment:output_type -> chef.automate.api.infra_proxy.response.UpdateNodeEnvironment
	90, // 106: chef.automate.api.infra_proxy.InfraProxy.GetPolicyfiles:output_type -> chef.automate.api.infra_proxy.response.Policyfiles
	91, // 107: chef.automate.api.infra_proxy.InfraProxy.GetPolicyfile:output_type -> chef.automate.api.infra_proxy.response.Policyfile
	92, // 108: chef.automate.api.infra_proxy.InfraProxy.DeletePolicyfile:output_type -> chef.automate.api.infra_proxy.response.DeletePolicyfile
	93, // 109: chef.automate.api.infra_proxy.InfraProxy.GetPolicyfileRevisions:output_type -> chef.automate.api.infra_proxy.response.PolicyfileRevisions
	94, // 110: chef.automate.api.infra_proxy.InfraProxy.GetPolicygroup:output_type -> chef.automate.api.infra_proxy.response.Policygroup
	95, // 111: chef.automate.api.infra_proxy.InfraProxy.GetOrgUsersList:output_type -> chef.automate.api.infra_proxy.response.OrgUsers
